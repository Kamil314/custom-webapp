...
export let usersArray = [
    ...
    { id: 1, username: 'wolski', password: 'wolski', firstName: 'Wolski', adres: 'Middenstraat', city: 'Zoetermeer', country: 'Nederland', loanType: 'Type: Hypotheek 0612', restLoan: 'Rest schuld: 81.312,-', rente: "Rente: 1,21%", woz: 'WOZ: 1.300.000,-', role: Role.Consument },
    ...
    { id: 3, username: 'kamil', password: 'kamil', firstName: 'Kamil', role: Role.User },
